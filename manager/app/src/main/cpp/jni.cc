...
Java_me_inkdye_vivoksu_Natives_getVersion(JNIEnv *env, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_me_inkdye_vivoksu_Natives_getKernelUAPIVersion(JNIEnv *env, jobject) {
    return get_kernel_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_me_inkdye_vivoksu_Natives_getManagerUAPIVersion(JNIEnv *env, jobject) {
    return get_manager_uapi_version();
}

extern "C"
JNIEXPORT jint JNICALL
Java_me_inkdye_vivoksu_Natives_getSuperuserCount(JNIEnv *env, jobject) {
...
Java_me_inkdye_vivoksu_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isLkmBundled(JNIEnv *env, jclass clazz) {
    return is_lkm_bundled();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isLateLoadMode(JNIEnv *env, jclass clazz) {
    return is_late_load_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isManager(JNIEnv *env, jclass clazz) {
    return is_manager();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isPrBuild(JNIEnv *env, jclass clazz) {
    return is_pr_build();
}
...
Java_me_inkdye_vivoksu_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("me/inkdye/vivoksu/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("me/inkdye/vivoksu/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
    return uid_should_umount(uid);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isSuEnabled(JNIEnv *env, jobject thiz) {
    return is_su_enabled();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_setSuEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_su_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isKernelUmountEnabled(JNIEnv *env, jobject thiz) {
    return is_kernel_umount_enabled();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_setKernelUmountEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_kernel_umount_enabled(enabled);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_inkdye_vivoksu_Natives_isSelinuxHideEnabled(JNIEnv *env, jobject thiz) {
    return is_selinux_hide_enabled();
}

extern "C"
JNIEXPORT jint JNICALL
Java_me_inkdye_vivoksu_Natives_setSelinuxHideEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
    return set_selinux_hide_enabled(enabled);
}

extern "C"
JNIEXPORT jstring JNICALL
Java_me_inkdye_vivoksu_Natives_getUserName(JNIEnv *env, jobject thiz, jint uid) {
...
Java_me_inkdye_vivoksu_magica_AppZygotePreload_forkDontCareAndExecKsud(JNIEnv *env, jclass clazz,
